...
router.post('/schedules/calculate-max/jobs/:jobId/stop', schedulesController.stopCalculateMaxCapacityJobHandler);
...
router.post('/schedules/:id/optimize/jobs', schedulesController.startOptimizeScheduleJobHandler);
router.get('/schedules/:id/optimize/jobs/:jobId', schedulesController.getOptimizeScheduleJobHandler);
router.post('/schedules/:id/optimize/jobs/:jobId/stop', schedulesController.stopOptimizeScheduleJobHandler);
